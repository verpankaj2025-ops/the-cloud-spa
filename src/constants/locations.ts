...
export const LUCKNOW_LOCATIONS: DetailedLocationSEO[] = [
  ...
  slug: 'vibhuti-khand',
  name: 'Vibhuti Khand',
  tagline: 'Best Luxury Spa Near Vibhuti Khand, TCS Awadh Park & Lucknow High Court',
  ...
  drivingRouteSummary:
    'Take Vibhuti Khand main road past TCS towards Lohia Path, cross the bridge into Vivek Khand 4 near Brijwasi Bakery.',
  metaTitle:
    'Best Spa Near Vibhuti Khand, Lucknow | The Cloud Spa',
  metaDescription:
    'Looking for a spa near Vibhuti Khand? Visit The Cloud Spa in Gomti Nagar, 5 minutes from TCS Awadh Park and Lucknow High Court, for Thai, Deep Tissue and Swedish Massage.',
  primaryKeywords: [
    'Spa near Vibhuti Khand',
    'Best Spa near Vibhuti Khand Lucknow',
    'Massage Center near Vibhuti Khand',
    'Spa near TCS Awadh Park',
    'Spa near High Court Lucknow',
    'Deep Tissue Massage Vibhuti Khand',
    'Thai Massage near Vibhuti Khand',
    'Massage Center near TCS Lucknow',
    'Spa near Indira Gandhi Pratishthan',
    'Spa near me Vibhuti Khand',
  ],
  heroSubtitle:
    'Just 5 minutes from TCS Awadh Park and Lucknow High Court, The Cloud Spa offers premium Thai, Deep Tissue and Swedish Massage in nearby Vivek Khand 4, Gomti Nagar.',
    introParagraphs: [
  ...
  slug: 'vivek-khand',
  name: 'Vivek Khand',
  tagline: 'Best Luxury Spa in Vivek Khand, Gomti Nagar',
  ...
  drivingRouteSummary:
    'Located inside Vivek Khand 4 at 4/526, right opposite Brijwasi Bakery and 100 meters from Manoj Pandey Chauraha.',
  metaTitle:
    'Best Spa in Vivek Khand, Gomti Nagar | The Cloud Spa',
  metaDescription:
    'Visit The Cloud Spa in Vivek Khand 4, Gomti Nagar, opposite Brijwasi Bakery. Enjoy Thai, Balinese, Deep Tissue and Couple Massage in a luxury private spa.',
  primaryKeywords: [
    'Spa in Vivek Khand Gomti Nagar',
    'Best Spa in Vivek Khand 4',
    'Luxury Spa Vivek Khand Lucknow',
    ...
    'Thai Massage Vivek Khand',
    'Couple Spa Vivek Khand',
    'Spa near me Vivek Khand',
  ],
  heroSubtitle:
    'The Cloud Spa is located directly in Vivek Khand 4, offering a convenient luxury wellness experience for residents of Vivek Khand 1, 2, 3 and 4.',
    introParagraphs: [
  ...
  slug: 'patrakarpuram',
  name: 'Patrakarpuram',
  tagline: 'Best Spa Near Patrakarpuram Crossing, Gomti Nagar',
  distanceFromSpa: '0.3 km',
  drivingTime: '1 min drive / 3 mins walk',
  landmarks: [
    'Patrakarpuram Crossing',
  ...
  drivingRouteSummary:
    'From Patrakarpuram Crossing, turn into Vivek Khand 4 road opposite Brijwasi Bakery; destination is 100 meters ahead.',
  metaTitle:
    'Best Spa Near Patrakarpuram, Gomti Nagar | The Cloud Spa',
  metaDescription:
    'Looking for a spa near Patrakarpuram? The Cloud Spa is 300 meters from Patrakarpuram Crossing in Vivek Khand 4, offering Thai, Deep Tissue and Swedish Massage.',
  primaryKeywords: [
    'Spa near Patrakarpuram Lucknow',
    'Best Spa near Patrakarpuram Gomti Nagar',
    'Massage Center near Patrakarpuram Crossing',
    'Massage Parlour Patrakarpuram Lucknow',
    'Spa near me Patrakarpuram',
    'Massage near Patrakarpuram Gomti Nagar',
    'Thai Massage near Patrakarpuram',
    'Deep Tissue Massage near Patrakarpuram',
    'Spa in Vivek Khand near Patrakarpuram',
    'Full Body Massage near Patrakarpuram',
  ],
  heroSubtitle:
    'Just 300 meters from Patrakarpuram Crossing, The Cloud Spa offers a quiet luxury wellness escape in nearby Vivek Khand 4, Gomti Nagar.',
  ...
  slug: 'indira-nagar',
  name: 'Indira Nagar',
  tagline: 'Best Luxury Spa Near Indira Nagar, Lucknow',
  ...
  drivingRouteSummary:
    'Take Munshipulia main road towards Polytechnic Flyover, cross over to Gomti Nagar via Patrakarpuram road to Vivek Khand 4.',
  metaTitle:
    'Best Spa Near Indira Nagar, Lucknow | The Cloud Spa',
  metaDescription:
    'Looking for a luxury spa near Indira Nagar? The Cloud Spa is 10 minutes from Bhootnath Market, offering Thai, Deep Tissue, Balinese and Couple Massage in Gomti Nagar.',
  primaryKeywords: [
    'Spa near Indira Nagar Lucknow',
    'Best Spa near Indira Nagar',
    'Massage Center near Indira Nagar Lucknow',
    'Body Massage Center Indira Nagar',
    'Massage Parlour near Bhootnath Market',
    'Spa near Munshipulia Lucknow',
    'Thai Massage near Indira Nagar',
    'Deep Tissue Massage near Indira Nagar',
    'Couple Spa near Indira Nagar Lucknow',
    'Spa near me Indira Nagar Lucknow',
  ],
  heroSubtitle:
    'Just 10 minutes from Bhootnath Market and Munshipulia, The Cloud Spa offers premium Thai, Deep Tissue, Balinese and Couple Massage in nearby Vivek Khand 4, Gomti Nagar.',
    introParagraphs: [
